...
/**
 * Tool exports (dbdiagram, etc.) often use MySQL-style `identifier` quoting in
 * otherwise PostgreSQL DDL. node-sql-parser (postgresql) expects plain or
 * double-quoted identifiers.
 */
function normalizeMysqlStyleBacktickIdentifiers(sql: string): string {
...
export async function fromPostgres(
    ...
    sqlContent = normalizeMysqlStyleBacktickIdentifiers(sqlContent);

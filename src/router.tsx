...
import { RequireSupabaseAuth } from './context/supabase-auth/require-supabase-auth';
import { RouteLoadError } from './components/route-load-error/route-load-error';
...
const routes: RouteObject[] = [
    {
        ...
        children: [
            ...[{ index: true as const }, { path: 'diagrams/:diagramId' }].map(
                (route) => ({
                    ...route,
                    lazy: loadEditorPage,
                })

...
export const ImportDatabaseDialog: React.FC<ImportDatabaseDialogProps> = ({
    ...
    const { resetFilter } = useDiagramFilter();
    ...
    const importDatabase = useCallback(async () => {
        ...
        queueMicrotask(async () => {
            // Clear schema/table visibility filter so imported tables are not hidden by a
            // stale filter (e.g. Postgres schema ids after switching to MySQL DDL).
            resetFilter();
